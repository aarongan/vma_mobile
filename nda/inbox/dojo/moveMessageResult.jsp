...
<json:object>
	...
	<json:object name="unread">
		<json:property name="All"
			value="${response.unreadSummaryInfo.totalAllMsgs}" />
		<json:property name="email"
			value="${response.unreadSummaryInfo.totalEmailMsgs}" />
		<json:property name="sms"
			value="${response.unreadSummaryInfo.totalSmsMsgs}" />
		<json:property name="mms"
			value="${response.unreadSummaryInfo.totalMmsMsgs}" />
		<json:property name="vvm"
			value="${response.unreadSummaryInfo.totalVvmMsgs}" />
