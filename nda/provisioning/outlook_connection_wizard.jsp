...
<body class="pl">
<div id="layer_holder" style="width:800px;height:390px">
<s:div id="loginDiv" theme="ajax">
<s:form action="createIcsEmailAccount.action">
<div id="main">
	<div id="contentDiv" style="float:left;width:535px;padding-top:10px;padding-right:10px;">
		...
		<div id="headingDiv" style="float:left;padding-top:15px;padding-left:10px;">
			...
			<span style="float:left; margin-left: 5px;padding-top:10px;">
				<strong>Connect with Outlook </strong>	
			</span><br/>			
		</div>
		<div id="descDiv" style="float:left;padding-top:15px;margin-left: 5px;padding-left:10px;">
			<span style="float:left; margin-left: 20px">
				To connect to your Outlook account, you just need to download and run the ICS
			</span><br/>
			<span style="float:left; margin-left: 20px">	
				installer below. It will ask you to open or restart Outlook and to verify your ICS
			</span><br/>				 
			<span style="float:left; margin-left: 20px">
				username and password.
			</span><br/>
			<span style="float:left;margin-left: 20px;padding-top:20px">
				<strong>Just download the ICS installer to begin</strong>
			</span><br/>							 							
		</div>		
		<div style="float:left;padding-top:15px;margin-left: 5px;padding-left:10px;"> 
			<span id="emailText" style="float:left;margin-left: 20px;">
				<a href="javascript:downloadOutlook();" class="button" id="downloadButton">
	   ...
	   <div id="buttonsBlock" style="display:block;float:left;margin-top:125px;margin-left:370px;">
	...
	<div id="helpDiv" style="float:left;width:225px;height:330px;margin-left:10px;margin-top:40px;border:1px solid #CCCCCC">
		<span style="float:left; margin-left: 10px">
			<strong>Do you know?</strong>				
		</span><br/><br/>
		<span style="float:left; margin-left: 10px;padding-top:5px"><strong>Sync</strong></span><br/>
