...
<div id="main">
	<div id="contentDiv" style="float:left;width:535px;padding-top:10px;padding-right:10px;">
		...
		<div id="headingDiv" style="float:left;padding-top:15px;padding-left:10px;">
			<span style="float:left; margin-left: 20px">
				<img alt="Google" src="<%=staticContentURL%>styles/images/ics/provision/providers/icons/medium/google.gif" /> 				
			</span>
		...
		<div id="descDiv" style="float:left;padding-top:15px;margin-left: 5px;padding-left:10px;">
			<span style="float:left; margin-left: 20px">
				We'll first connect with your Google account, then give you options for syncing
			</span><br/>
			<span style="float:left; margin-left: 20px">	
				the account. If you have multiple Google accounts, please choose just one
			</span><br/>				 
			<span style="float:left; margin-left: 20px">
				to connect.
			</span><br/>
			<span style="float:left;margin-left: 20px;padding-top:20px">
				<strong>Enter your Google login information.</strong>
			</span><br/>							 							
		</div>		
