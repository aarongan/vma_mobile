...
<div id="main">
	<div id="contentDiv" style="float:left;width:535px;padding-top:10px;padding-right:10px;">
		...
		<div id="headingDiv" style="float:left;padding-top:15px;padding-left:10px;">
			<span style="float:left; margin-left: 20px">
				<img alt="MSN" src="<%=staticContentURL%>styles/images/ics/provision/providers/icons/medium/msn.gif" /> 				
			</span>
			<span style="float:left; margin-left: 5px;padding-top:10px;">
				<strong>Connect with MSN </strong>	
			</span><br/>			
		</div>
		<div id="descDiv" style="float:left;padding-top:15px;margin-left: 5px;padding-left:10px;">
			<span style="float:left; margin-left: 20px">
				We'll first connect with your MSN account, then give you options for syncing
			</span><br/>
			<span style="float:left; margin-left: 20px">	
				the account. If you have multiple MSN accounts, please choose just one
			</span><br/>				 
			<span style="float:left; margin-left: 20px">
				to connect.
			</span><br/>
			<span style="float:left;margin-left: 20px;padding-top:20px">
				<strong>Enter your MSN login information.</strong>
			</span><br/>							 							
		</div>		
		...
		<div id="errorBlock" style="display:none;float:left;margin-top:20px;margin-left: 35px;padding:5px;border: 1px solid red;"> 
			<span style="float:left;">
				<img alt="Error" src="<%=staticContentURL%>styles/styles/images/ics/provision/error_alert.gif" /> 		
			</span>
