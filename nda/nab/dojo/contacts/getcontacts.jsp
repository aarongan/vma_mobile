 ...
 <json:object> 
  ...
  <json:array name="items" items="${clResponse.contacts}" var="contact">
	<json:object>
	 ...
	 <json:property name="vzwNumber" value="${contact.vzwNumber}"/>
