...
<html>
	<head>
     ...
     <div class="gb">
		...
		<p>You are seeing this page due to one of the below </p> 
		<p>
			1) The MDN might be suspended.
		</p>
		<p>
			2) The MDN might be disconnected.
		</p>
		<p>
			2) The Sync & Connect Feature might be removed/de-activated.
		</p>
		</div>
